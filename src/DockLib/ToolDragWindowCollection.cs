...
namespace DockLib
{
	...
	public sealed class ToolDragWindowCollection : IList, IList<ToolDragWindow>
	{
		...
		void IList<ToolDragWindow>.Insert(int index, ToolDragWindow item) => throw new NotSupportedException();
		void IList<ToolDragWindow>.RemoveAt(int index) => throw new NotSupportedException();
		...
		void ICollection<ToolDragWindow>.Add(ToolDragWindow item) => throw new NotSupportedException();
		void ICollection<ToolDragWindow>.Clear() => throw new NotSupportedException();
		bool ICollection<ToolDragWindow>.Remove(ToolDragWindow item) => throw new NotSupportedException();
		[DebuggerBrowsable(DebuggerBrowsableState.Never)]
